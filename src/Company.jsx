...
export default function Company() {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      const response = await fetch(`${API_BASE_URL}/api/admin/companies/${companyToDelete.id}`, {
        method: 'DELETE',
        headers: headers,
      });
  ...
  return (
    <div className="min-h-screen p-4 md:p-6 lg:p-8 lg:max-w-7xl mx-auto">
      {/* Success Toast */}
      {showSuccess && (
              ...
              <div className="mb-6">
                ...
                <div className="flex gap-3">
                  ...
                  <button
                    ...
                    className={`px-6 py-3 ${getButtonGradient()} ${getButtonHover()} text-white font-medium rounded-xl flex items-center gap-2`}
                  >
                      ...
                      <div key={token.id} className="border border-gray-200 rounded-xl p-4 hover:bg-gray-50 transition-colors">
                        <div className="flex items-center justify-between">
                          <div>
                            ...
                            <p className="text-sm text-gray-500">{token.company}</p>
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="p-2 rounded-xl hover:bg-gray-100 hidden md:inline-flex"
              title="Token Manager"
            >
            ...
            <button 
              ...
              className="hidden lg:flex items-center gap-2 px-4 py-2 bg-white border border-gray-300 rounded-xl text-sm hover:bg-gray-50"
            >
        ...
        <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl p-6 text-white shadow-lg">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold mt-2">{summaryData.total}</p>
            </div>
        ...
        <div className="bg-gradient-to-br from-green-500 to-green-600 rounded-2xl p-6 text-white shadow-lg">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold mt-2">{summaryData.active}</p>
            </div>
        ...
        <div className="bg-gradient-to-br from-purple-500 to-purple-600 rounded-2xl p-6 text-white shadow-lg">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold mt-2">{summaryData.admins}</p>
            </div>
        ...
        <div className="bg-gradient-to-br from-orange-500 to-orange-600 rounded-2xl p-6 text-white shadow-lg">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold mt-2">{summaryData.employees}</p>
            </div>
      ...
      {viewMode === 'card' && (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredCompanies.map((company) => (
            <div key={company.id} className="bg-white rounded-2xl shadow-lg border border-gray-200/50 p-6 hover:shadow-xl transition-shadow">
              ...
              <div className="space-y-3 mb-4">
                ...
                <div className="flex items-center gap-2 text-sm text-gray-600">
                  ...
                  <span>{company.office_check_in} - {company.office_check_out}</span>
                </div>
              </div>
