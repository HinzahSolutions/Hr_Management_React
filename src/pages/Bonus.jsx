...
const Bonus = () => {
    ...
    const bonusData = [
        { id: 1, empId: "2001", name: "John Doe", role: "CEO", group: "IT Team", month: "Jan", year: "2025", bonus: 0 },
        { id: 2, empId: "2002", name: "Mark Williams", role: "Developer", group: "IT Team", month: "Jan", year: "2025", bonus: 0 },
        { id: 3, empId: "2003", name: "Stephen McDonald", role: "Developer", group: "IT Team", month: "Jan", year: "2025", bonus: 0 },
        { id: 4, empId: "2004", name: "Kumar Swaminathan", role: "Designer", group: "IT Team", month: "Jan", year: "2025", bonus: 0 },
    ];
    ...
    return (
        <div className="container-fluid p-3 mt-4">
                    ...
                    <tbody>
                        {filteredData.map((employee, index) => (
                            <tr key={employee.id}>
                                ...
                                <td>{employee.year}</td>
                                <td>
                                    <Form.Control type="number" min="0" value={employee.bonus} />
                                </td>
                                <td>
            ...
            <Button variant="primary" className="mt-3">+ Bulk Action</Button>
        </div>
    );
};
